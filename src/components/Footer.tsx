/**
 * Component: Footer
 * Purpose: Website footer with links and contact information
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="px-4 mx-auto max-w-2xl">
              <img
                ...
                className="h-8 sm:h-10 lg:h-[50px] w-auto object-contain mb-4"
              />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/publications" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Publications
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/projects/vibronav" className="text-gray-300 hover:text-white transition-colors duration-200">
                  VibroNav Project
                </Link>
              </li>
              <li>
                <Link to="/projects/ultraclear" className="text-gray-300 hover:text-white transition-colors duration-200">
                  UltraClear Project
                </Link>
              </li>
              <li>
                <Link to="/opportunities" className="text-gray-300 hover:text-white transition-colors duration-200">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0 text-center md:text-left">
              <p>© 2025 HealthTech Innovation Lab. All rights reserved.</p>
              <div className="mt-1 flex items-center justify-center md:justify-start gap-3">
                <span>Made by <span className="text-gray-300 font-medium">Oğuzhan Berke Özdil</span></span>
                <div className="flex space-x-2">
                  <a href="https://www.linkedin.com/in/oguzhanberkeozdil/" className="text-gray-400 hover:text-white transition-colors duration-200">
                    <span className="sr-only">LinkedIn</span>
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                    </svg>
                  </a>
                  <a href="https://github.com/oguzhanberkeozdil" className="text-gray-400 hover:text-white transition-colors duration-200">
