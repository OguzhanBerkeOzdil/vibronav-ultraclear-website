...
const galleryImages = [
  {
    src: buildAssetUrl('assets/images/projects/gallery/photo-1.jpeg'),
    alt: 'Experimental setup and device testing',
    caption: 'Experimental setup and device testing',
    category: 'Laboratory'
  },
  {
    src: buildAssetUrl('assets/images/projects/gallery/photo-2.jpeg'),
    alt: 'Checking device performance',
    caption: 'Checking Device performance',
    category: 'Laboratory'
  },
  {
    src: buildAssetUrl('assets/images/projects/gallery/photo-3.jpeg'),
    alt: 'Testing robot arm and device integration',
    caption: 'Testing robot arm and device integration',
    category: 'Laboratory'
  },
  {
    src: buildAssetUrl('assets/images/projects/gallery/photo-4.jpeg'),
    alt: 'Conference presentation',
    caption: 'Conference presentation',
    category: 'Presentation'
  },
  {
    src: buildAssetUrl('assets/images/projects/gallery/photo-5.jpeg'),
    alt: 'A team photo',
    caption: 'A team photo',
    category: 'Laboratory'
  },
  {
    src: buildAssetUrl('assets/images/projects/gallery/photo-6.jpeg'),
    alt: 'Device testing and medical validation',
    caption: 'Device testing and medical validation',
    category: 'Device'
  },
  {
    src: buildAssetUrl('assets/images/projects/gallery/photo-7.jpeg'),
    alt: 'Checking device performance',
    caption: 'Checking device performance',
    category: 'Device'
  },
  {
    src: buildAssetUrl('assets/images/projects/gallery/photo-8.jpeg'),
    alt: 'Research in laboratory',
    caption: 'Research in laboratory',
    category: 'Research'
  },
  {
    src: buildAssetUrl('assets/images/projects/gallery/photo-9.jpeg'),
